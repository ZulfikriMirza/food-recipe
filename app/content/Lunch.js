...
export default function Lunch() {
    return (
        <div className={`${styles.Lunch__body} rounded-lg`}>
            <h1 className='mb-8 mt-4 font-bold text-6xl'>Lunch</h1>
            <div className={styles.Lunch__cardBody}>
                <div className={`${styles.Lunch__card} flex flex-col gap-4`}>
                ...
                <div className={styles.Lunch__card}>
                    <div>
                        <h1>2. Ipsum</h1>
                    </div>
                    <div>
