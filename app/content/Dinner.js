...
export default function Dinner() {
    return (
        <div className={`${styles.Dinner__body} rounded-lg`}>
            <h1 className='mb-8 mt-4 font-bold text-6xl'>Dinner</h1>
            <div className={styles.Dinner__cardBody}>
                <div className={`${styles.Dinner__card} flex flex-col gap-4`}>
                ...
                <div className={styles.Dinner__card}>
                    <div>
                        <h1>2. Ipsum</h1>
                    </div>
                    <div>
